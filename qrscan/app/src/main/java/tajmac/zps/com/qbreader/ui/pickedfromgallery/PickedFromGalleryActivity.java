package tajmac.zps.com.qbreader.ui.pickedfromgallery;
...
import tajmac.zps.com.qbreader.databinding.ActivityPickedFromGalleryBinding;
...
public class PickedFromGalleryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void loadQRCode() {
        ...
        Log.d("We are Here !! ", "loadQRBitMAp: ");
        if (intent != null) {
