package tajmac.zps.com.qbreader.helpers.util;
...
import tajmac.zps.com.qbreader.QrBarScanApplication;
...
public class PermissionUtil {
    ...
    boolean isAllowed(String permission) {
        ...
        return QrBarScanApplication.getContext().checkSelfPermission(permission)
