package tajmac.zps.com.qbreader.ui.scan;
...
import tajmac.zps.com.qbreader.helpers.util.image.ImageInfo;
import tajmac.zps.com.qbreader.helpers.util.image.ImagePicker;
import tajmac.zps.com.qbreader.ui.pickedfromgallery.PickedFromGalleryActivity;
...
public class ScanFragment extends androidx.fragment.app.Fragment implements View.OnClickListener {
        ...
        mBarcodeView.decodeSingle(new BarcodeCallback() {
            ...
            public void barcodeResult(BarcodeResult result) {
                ...
                if (result != null
                    ...
                    /* Probably here our image is store */
                    Intent intent = new Intent(mContext, ScanResultActivity.class);
                    intent.putExtra(IntentKey.MODEL, code);
                    //intent.removeExtra(code.getContent());
                    //intent.getExtras().clear();
                    Log.d(code.getDescribe(), "barcodeResultllll: ");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ImagePicker.REQUEST_CODE_PICK_IMAGE && mContext != null) {
            ...
            String STR = "A string to be encoded as QR code";
            /* Upload Scanned Code PDF */
            /*  Nefunguje to a nevim pak proc */
            ...
            try {
                ...
                if(data != null) {
                    bitmap = HelperMethods.encodeAsBitmap(data.getDataString());
                }
                else {
                    bitmap = HelperMethods.encodeAsBitmap("A string to be encoded as QR code");
                }
            ...
            Result result = null;
            if(bitmap!= null) {
                result = processBitmapToGetResult(bitmap);
            }
